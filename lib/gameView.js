(function () {
  ...
  GameView.prototype.start = function () {
    this.game.stepInterval = setInterval(this.game.step.bind(this.game, this.ctx), 20);
    this.game.drawInterval = setInterval(this.game.draw.bind(this.game, this.ctx), 20);
