(function () {
  ...
  Game.prototype.handlePressedKeys = function () {
    ...
    if (pressedKeys.indexOf(87) >= 0) { this.ship.power([0, -1]); }
    if (pressedKeys.indexOf(65) >= 0) { this.ship.power([-1, 0]); }
    if (pressedKeys.indexOf(83) >= 0) { this.ship.power([0, 1]); }
    if (pressedKeys.indexOf(68) >= 0) { this.ship.power([1, 0]); }
